...
IGNORAR_FICH='marca-inubia\.md|/marca\.md$|MASTER-PROMPT|red-list\.md|_backups/|_legado/|\.bak|\.pre-|/antes\.(html|md)$|ghost-check/SKILL\.md|sombra-reflexion-checklist\.md|/agents/(copy|rs|eco)\.md$'

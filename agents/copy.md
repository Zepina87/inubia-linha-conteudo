...
4b. Ler `~/inubia-conteudo/o-copy/inputs/urls-inubia-pt-AAAAMMDD.txt` (inventário do sitemap de inubia.pt sem imagens; 38 URLs a 17-09-2026). Regenerar quando tiver mais de 30 dias: `curl -sL https://inubia.pt/post-sitemap1.xml https://inubia.pt/page-sitemap1.xml | grep -oE 'https://inubia\.pt/[^<"]+' | sort -u`. Links internos (critério 12) só de URLs que estão no inventário E respondem 200 no dia.
